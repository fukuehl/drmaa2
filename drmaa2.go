...
func (ms *MonitoringSession) GetAllJobs() (jobs []Job, err error) {
	cjlist := (C.drmaa2_j_list)(C.drmaa2_msession_get_all_jobs(ms.ms, nil))
	if cjlist == nil {
		return nil, makeLastError()
	}
...
func (ms *MonitoringSession) GetAllQueues() (queues []Queue, err error) {
	cqlist := (C.drmaa2_list)(C.drmaa2_msession_get_all_queues(ms.ms, nil))
	if cqlist == nil {
		return nil, makeLastError()
	}
...
func (ms *MonitoringSession) GetAllMachines() (machines []Machine, err error) {
	milist := (C.drmaa2_list)(C.drmaa2_msession_get_all_machines(ms.ms, nil))
	if milist == nil {
		return nil, makeLastError()
	}
